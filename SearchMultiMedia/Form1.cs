...
namespace SearchMultiMedia
{
    ...
    {
        private string connectionString = "Data Source=4-21-EA-36-F\\MSSQLSERVER01;Initial Catalog=DPT1;Integrated Security=True;Encrypt=True;Trust Server Certificate=True";
