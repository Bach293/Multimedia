...
namespace BuildDatabase
{
    internal class TextCls
    {
        ...
        {
            string query = "UPDATE VanBan SET TieuDeXLNNTN = @TieuDeXLNNTN, NoiDungTomTatXLNNTN = @NoiDungTomTatXLNNTN, NoiDungXLNNTN = @NoiDungXLNNTN WHERE ID = @Id";
        ...
        {
            string selectQuery = "SELECT ID, TieuDe, NoiDungTomTat, NoiDung FROM VanBan";
